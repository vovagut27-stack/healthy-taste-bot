...
RECIPES: list[Recipe] = [
    ...
    Recipe(
        ...
        steps=[
            "Измельчите нут, петрушку, чеснок и кumin, сформируйте шарики.",
        ...
        tips=["Используйте готовый фалафель для экономии времени", "Добавьте тahini соус"],
    ...
    Recipe(
        ...
        fat=12,
        carbs=4,
        benefits=["Йод и цинк", "Низкокалорийный белок", "Кето-friendly"],
    ...
    Recipe(
        ...
        ingredients=[
            ...
            "Арахисовая пasta — 1 ч. л. (опционально)",
        ],
        steps=[
    ...
    Recipe(
        ...
        steps=[
            ...
            "Тушите 20 минут, в конце добавьте шпinат.",
        ],
        calories=340,
        protein=35,
        fat=14,
